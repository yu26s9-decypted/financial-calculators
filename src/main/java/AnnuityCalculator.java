...
//
    ...
    public static double askForDouble(String prompt, Scanner scanner){
...
//                Input Mismtch: checks if the user input data matches the expected datatype.
            } catch (InputMismatchException exception) {
                scanner.nextLine();
                System.out.printf("There is a input mismatch, please type your input again: %s", prompt);
            }
        }
        return value;
    }
    ...
    public static void main(String[] arg){
        ...
        double monthlyPayout = askForDouble("What is your desired monthly payout? $", scanner);
        double expectedInterest = askForDouble("What is your expected interest? (in percentages): ", scanner);
        double payoutTimeInYears = askForDouble("How many years until payout? (yrs): ", scanner);
